...
const NAMES = ['Дарья', 'Вадим', 'Екатерина', 'Дмитрий', 'Елена', 'Сергей', 'Софья', 'Константин', 'Зоя', 'Александр'];
...
const DESCRIPTIONS = ['Эту фотографию я сделал сам! #me', 'С друзьями на шашлыках #отдых', 'Это мы на отдыхе #отдыхаемхорошо #веселоидружно', 'Собрались со всей семьей дома #милыйдом #отдыхаем #уютный вечер', 'Еду домой! #милыйдом #уютный вечер'];
